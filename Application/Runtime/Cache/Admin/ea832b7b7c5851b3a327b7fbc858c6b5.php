                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php if(is_array($carousel)): $i = 0; $__LIST__ = $carousel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ca): $mod = ($i % 2 );++$i;?><tr id="ca_<?php echo ($ca["c_id"]); ?>">
                                            <td><img src="/ChildrenPlatform/Public/Uploads/carouselpic/<?php echo ($ca["pic"]); ?>" width="50"></td>
                                            <td><?php echo ($ca["name"]); ?></td>
                                            <td>
                                                <?php if(($ca["state"] == 0)): ?><span id="state_ca_<?php echo ($ca["c_id"]); ?>" class="label label-success">正常</span>
                                                    <?php else: ?>
                                                    <span id="state_ca_<?php echo ($ca["c_id"]); ?>" class="label label-danger">禁用</span><?php endif; ?>
                                            </td>
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <?php if(($ca["state"] == 0)): ?><a id="change_ca_<?php echo ($ca["c_id"]); ?>"
                                                                   onclick="change_state_carousel('<?php echo ($ca["c_id"]); ?>',1)"
                                                                   href="javascript:;"><i
                                                                        class="icon-envelope"></i>暂停使用</a>
                                                                <?php else: ?>
                                                                <a id="change_ca_<?php echo ($ca["c_id"]); ?>"
                                                                   onclick="change_state_carousel('<?php echo ($ca["c_id"]); ?>',0)"
                                                                   href="javascript:;"><i
                                                                        class="icon-envelope"></i>取消禁用</a><?php endif; ?>
                                                        </li>
                                                        <li><a onclick="del_carousel('<?php echo ($ca["c_id"]); ?>')" href="javascript:;">
                                                            删除轮播图</a></li>
                                                    </ul>
                                                </div>
                                            </td>
