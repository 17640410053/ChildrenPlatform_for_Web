                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr id="type_<?php echo ($list["subsettype_id"]); ?>">
                                            <td id="name_type_<?php echo ($list["subsettype_id"]); ?>"><?php echo ($list["name"]); ?></td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a onclick="del_subset_type('<?php echo ($list["subsettype_id"]); ?>')" href="javascript:;">
                                                            删除分类</a></li>
                                                        <li><a onclick="update_subset_type('<?php echo ($list["subsettype_id"]); ?>')" href="javascript:;">
                                                            修改分类</a></li>
                                                    </ul>
                                                </div>
                                            </td>
