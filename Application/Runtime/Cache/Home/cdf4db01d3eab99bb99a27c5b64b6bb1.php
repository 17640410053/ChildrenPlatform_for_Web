...
<head>
    ...
    <!-- Basic page needs
	============================================ -->
    <title><?php echo ($user_detail["username"]); ?>- 购物车</title>
    <meta charset="utf-8">
                    ...
                    <div class="modcontent">
                        <div class="box-category">
                            <ul id="cat_accordion" class="list-group">
                                ...
                                <li>
                                    <a href="user_cart" class="cutom-parent">我的购物车</a><span
                                        class="dcjq-icon"></span>
                                </li>
                                <li>
                    ...
                    <form id="user_detail_form" action="" method="post" enctype="multipart/form-data"
                        ...
                        <div class="buttons">
                            <div class="pull-right">
                                <input type="button" value="清空购物车" class="btn btn-primary" onclick="save_user_detail('<?php echo ($user_detail["user_id"]); ?>')">
                                <input type="button" value="立即结算" class="btn btn-primary" onclick="save_user_detail('<?php echo ($user_detail["user_id"]); ?>')">
                            </div>
                        </div>
                    </form>
                </div>
