                        ...
                        <div class="tabBlock">
                            <?php if(($_SESSION['user_id']== null)): ?><ul class="top-link list-inline" id="lo">
                                ...
                                <ul class="top-link list-inline" id="ur">
                                    <li class="account" id="my_account">
                                        <a href="#" class="btn btn-xs dropdown-toggle"
                                           data-toggle="dropdown" id="username"> <span><?php echo (session('user_name')); ?></span>
                                            <span
                                                    class="fa fa-angle-down"></span></a>
                                        <ul class="dropdown-menu ">
                                    ...
                                    <li class="wishlist"><a href="#" id="wishlist-total"
                                                            class="top-link-wishlist"><span> 收藏 (<?php echo ($count_num); ?>)</span></a>
                                    </li>
                        ...
                        <div id="search0" class="search input-group">
                            <div class="select_category filter_type icon-select">
                                <select class="no-border" name="category_id" id="category_id">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mt): $mod = ($i % 2 );++$i;?><option value="<?php echo ($mt["type_id"]); ?>"><?php echo ($mt["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                                ...
                                <?php if(is_array($item)): $i = 0; $__LIST__ = $item;if( count($__LIST__)==0 ) : echo "暂无匹配结果！" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><div class="product-layout col-md-4 col-sm-6 col-xs-12 ">
                                        <div class="product-item-container">
                                            ...
                                            <div class="right-block">
                                                <div class="caption">
                                                    <h4><a href="<?php echo U('Project/project_detail?id='.$item['commodity_id']);?>">
