            ...
            <div class="row">
                <div id="content" class="col-md-12 col-sm-12">
                    <div class="related titleLine products-list grid module ">
                        <h3 class="modtitle"> &nbsp;搜索结果</h3>
                        <?php if(is_array($search)): $i = 0; $__LIST__ = $search;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$search): $mod = ($i % 2 );++$i;?><div class="releate-products ">
                                <div class="product-layout">
                                    <div class="product-item-container">
                                        <div>
                                            <div style="width: 130px;float: left;">
                                                <img src="/ChildrenPlatform/Public/Uploads/commodity_image/<?php echo ($search["small_pic"]); ?>"
                                                     style="width: 130px">
                                            </div>
                                            <div class="right-block" style="display: inline">
                                                <div class="caption" style="margin-left: 13%;">
                                                    <h4 style="margin-top:6px "><a target="_blank"
                                                            href="<?php echo U('Project/project_detail?id='.$search['commodity_id']);?>"><?php echo ($search["name"]); ?></a>
                                                    </h4>
                                                    <div class="ratings">
                                                        <div class="rating-box">
                                                            <?php if(($search["starnum"] == 0)): ?><span style="color: #ebdb2c"> 暂无评价</span>
                                                                <?php else: ?>
                                                                <span class="fa fa-stack">
                                                                                    <?php if(($search["starnum"] > 0)): ?><i class="fa fa-star fa-stack-1x"></i>
                                                                                        <?php else: ?>
                                                                                        <i class="fa fa-star-o fa-stack-1x"></i><?php endif; ?>
                                                                                </span>

                                                                <span class="fa fa-stack">
                                                                                    <?php if(($search["starnum"] > 1)): ?><i class="fa fa-star fa-stack-1x"></i>
                                                                                        <?php else: ?>
                                                                                        <i class="fa fa-star-o fa-stack-1x"></i><?php endif; ?>
                                                                                </span>

                                                                <span class="fa fa-stack">
                                                                                    <?php if(($search["starnum"] > 2)): ?><i class="fa fa-star fa-stack-1x"></i>
                                                                                        <?php else: ?>
                                                                                        <i class="fa fa-star-o fa-stack-1x"></i><?php endif; ?>
                                                                                </span>

                                                                <span class="fa fa-stack">
                                                                                    <?php if(($search["starnum"] > 3)): ?><i class="fa fa-star fa-stack-1x"></i>
                                                                                        <?php else: ?>
                                                                                        <i class="fa fa-star-o fa-stack-1x"></i><?php endif; ?>
                                                                                </span>

                                                                <span class="fa fa-stack">
                                                                                    <?php if(($search["starnum"] > 4)): ?><i class="fa fa-star fa-stack-1x"></i>
                                                                                        <?php else: ?>
                                                                                        <i class="fa fa-star-o fa-stack-1x"></i><?php endif; ?>
                                                                                </span><?php endif; ?>
                                                        </div>
                                                    ...
                                                    <div class="price">
                                                        <span class="price-new">￥<?php echo ($search["price"]); ?></span>
                                                        <!--<span class="price-old">$122.00</span>-->
                                                        <!--<span class="label label-percent">-40%</span>-->
                                                    </div>
                                                </div>
                                                <div class="button-group" style="margin-left: 13%">
                                                    <a target="_blank" href="<?php echo U('Project/project_detail?id='.$search['commodity_id']);?>">
                                                        <button class="addToCart" data-toggle="tooltip"
                                                                title="查看详情">
                                                            <span class="hidden-xs">查看详情</span></button>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
