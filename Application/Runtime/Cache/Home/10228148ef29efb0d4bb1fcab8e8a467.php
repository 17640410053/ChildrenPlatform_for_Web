...
<head>
    ...
    <!-- Basic page needs
	============================================ -->
    <title>物品详情-<?php echo ($detail["f_name"]); ?></title>
    <script src="http://libs.baidu.com/jquery/2.1.4/jquery.min.js"></script>
    <script>
        var AppUrl = "/ChildrenPlatform";
        var com_u_id = "<?php echo (session('u_id')); ?>";
        var check_u_id = "<?php echo (session('u_id')); ?>"
        var com_f_id = "<?php echo ($detail["f_id"]); ?>";
        var star_num = "<?php echo ($detail["star"]); ?>";
...
<div class="box">
    ...
    <div class="main-container container">
        <ul class="breadcrumb">
            <li><a href="#"><?php echo ($detail["f_name"]); ?>-物品详情</a></li>
        </ul>
        <div class="row">
                            ...
                            <div class="content-product-left class-honizol col-sm-6-1 col-xs-12 ">
                                <div>
                                    <img itemprop="image" class="product-image-zoom"
                                         src="/ChildrenPlatform/Public/Uploads/itempic/<?php echo ($detail["s_pic"]); ?>"
                                         alt="Bint Beef">
                                </div>
                            </div>
                            <div class="content-product-right col-sm-6-2-1 col-xs-12">
                                <div class="title-product">
                                    <h1><?php echo ($detail["f_name"]); ?></h1>
                                </div>
                                <!-- Review ---->
                                <div class="box-review form-group">
                                    ...
                                    <?php if(($detail["collect_state"] == 1)): ?><a id="collect_btn_<?php echo ($detail["f_id"]); ?>" onclick="collect('<?php echo ($detail["collect_state"]); ?>','<?php echo ($detail["f_id"]); ?>')"><span id="collect_font_<?php echo ($detail["f_id"]); ?>"> 取消收藏</span></a>
                                        <?php else: ?>
                                        <a id="collect_btn_<?php echo ($detail["f_id"]); ?>" onclick="collect('<?php echo ($detail["collect_state"]); ?>','<?php echo ($detail["f_id"]); ?>')"><span id="collect_font_<?php echo ($detail["f_id"]); ?>"> 添加到我的收藏</span></a><?php endif; ?>
                                </div>
                                ...
                                <div class="product-box-desc">
                                    <div class="inner-box-desc">
                                        ...
                                        <div class="reward" style="margin-bottom: 10px"><span>电话：</span>
                                            <?php if(($detail["telephone"] == null)): ?>此项目无联系电话！
                                                <?php else: ?>
                                                <?php echo ($detail["telephone"]); endif; ?>
                                        </div>
                                        <div class="brand" style="margin-bottom: 10px"><span>分类：</span> <?php echo ($detail["s_id"]); ?>
                                        </div>
                                    ...
                                    <?php if(is_array($comment)): $i = 0; $__LIST__ = $comment;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$com): $mod = ($i % 2 );++$i;?><table class="table table-striped table-bordered">
                                            ...
                                            <?php if(is_array($com[voo])): $i = 0; $__LIST__ = $com[voo];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><tr>
                                                    <td rowspan="2" style="width: 100px"><img
                                                            src="/ChildrenPlatform/Public/Uploads/userpic/<?php echo ($user["pic"]); ?>"
                                                            style="width: 100px">
                                                    </td>
                                                        ...
                                                        <div class="product-item-container">
                                                            <div class="left-block">
                                                                <div class="product-image-container">
                                                                    <img src="/ChildrenPlatform/Public/Uploads/itempic/<?php echo ($hot["s_pic"]); ?>"
                                                                         alt="Apple Cinema 30&quot;"
                                                                ...
                                                                <a class="quickview visible-lg" target="_blank"
                                                                   href="<?php echo U('Project/projectdetail?id='.$hot['f_id']);?>">
                                                                    马上浏览</a>
                                                            ...
                                                            <div class="right-block">
                                                                <div class="caption">
                                                                    <h4><a target="_blank"
                                                                           href="<?php echo U('Project/projectdetail?id='.$hot['f_id']);?>"><?php echo ($hot["f_name"]); ?></a>
                                                                    </h4>
                                                                    <div class="ratings">
                                                                        <div class="rating-box">
                                                                            <?php if(($hot["star"] == 0)): ?><span style="color: #ebdb2c"> 暂无评价</span>
                                                                                <?php else: ?>
                                                                                <span class="fa fa-stack">
                                                                                    <?php if(($hot["star"] > 0)): ?><i class="fa fa-star fa-stack-1x"></i>
                                                                                        <?php else: ?>
                                                                                        <i class="fa fa-star-o fa-stack-1x"></i><?php endif; ?>
                                                                                </span>

                                                                                <span class="fa fa-stack">
                                                                                    <?php if(($hot["star"] > 1)): ?><i class="fa fa-star fa-stack-1x"></i>
                                                                                        <?php else: ?>
                                                                                        <i class="fa fa-star-o fa-stack-1x"></i><?php endif; ?>
                                                                                </span>

                                                                                <span class="fa fa-stack">
                                                                                    <?php if(($hot["star"] > 2)): ?><i class="fa fa-star fa-stack-1x"></i>
                                                                                        <?php else: ?>
                                                                                        <i class="fa fa-star-o fa-stack-1x"></i><?php endif; ?>
                                                                                </span>

                                                                                <span class="fa fa-stack">
                                                                                    <?php if(($hot["star"] > 3)): ?><i class="fa fa-star fa-stack-1x"></i>
                                                                                        <?php else: ?>
                                                                                        <i class="fa fa-star-o fa-stack-1x"></i><?php endif; ?>
                                                                                </span>

                                                                                <span class="fa fa-stack">
                                                                                    <?php if(($hot["star"] > 4)): ?><i class="fa fa-star fa-stack-1x"></i>
                                                                                        <?php else: ?>
                                                                                        <i class="fa fa-star-o fa-stack-1x"></i><?php endif; ?>
                                                                                </span><?php endif; ?>
                                                                        </div>
                                                                ...
                                                                <div class="button-group">
                                                                    <?php if(is_array($hot[voo])): $i = 0; $__LIST__ = $hot[voo];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$col): $mod = ($i % 2 );++$i; if(($col["state"] == 1)): ?><button class="wishlist" type="button"
                                                                                    data-toggle="tooltip"
                                                                                    id="collect_btn_<?php echo ($hot["f_id"]); ?>"
                                                                                    onclick="collect('<?php echo ($col["state"]); ?>','<?php echo ($hot["f_id"]); ?>')">
                                                                                <i class="fa fa-heart"></i>
                                                                                <span id="collect_font_<?php echo ($hot["f_id"]); ?>"> 取消收藏</span>
                                                                            </button>
                                                                            <?php else: ?>
                                                                            <button class="wishlist" type="button"
                                                                                    ...
                                                                                    onclick="collect('<?php echo ($col["state"]); ?>','<?php echo ($hot["f_id"]); ?>')">
                                                                                <i class="fa fa-heart"></i>
                                                                                <span id="collect_font_<?php echo ($hot["f_id"]); ?>"> 添加到我的收藏</span>
